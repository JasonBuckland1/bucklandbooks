...
const quizData = [
    ...
    group: "3.0",
    questions: [
       { question: "", answers: ["Next"], correctAnswerIndex: 0 },
      { question: "", answers: ["Next"], correctAnswerIndex: 0 },
      { question: "", answers: ["Next"], correctAnswerIndex: 0 },
      { question: "", answers: ["Next"], correctAnswerIndex: 0 },
      { question: "", answers: ["Next"], correctAnswerIndex: 0 },
    ...
    
  {
    ...
    questions: [
      ...
      { question: "", answers: ["farm", "office", "restaurant", "construction site"], correctAnswerIndex: 2, image: "img/quizImg/restaurant.jpg"},
  ...
  },
  {
    ...
    questions: [
      ...
      { question: "I ____ a bath on Wednesdays.", answers: ["take", "takes"], correctAnswerIndex: 0 },
      ...
      { question: "He _____ work outside.", answers: ["do not", "does not"], correctAnswerIndex: 1 },
      ...
      { question: "____ you work in a school?", answers: ["Does", "Do"], correctAnswerIndex: 1 },
      { question: "____ they live in Paris?", answers: ["Does", "Do?"], correctAnswerIndex: 1 },
      { question: "_____ they eat breakfast?", answers: ["Do", "Does"], correctAnswerIndex: 0 },
      { question: "_____ she like coffee?", answers: ["Is", "Do", "Does"], correctAnswerIndex: 2 },
  ...
  },
  {
    ...
    questions: [
      ...
      { question: "", answers: ["socks", "boots", "shoes", "sneakers"], correctAnswerIndex: 3, image: "img/quizImg/sneakers.jpg" },
      ...
      { question: "'Does this sweater fit? 'No, it is ____ .' ", answers: ["not big enough", "big enough", "too big"], correctAnswerIndex: 2, image: "img/quizImg/big.jpg" },
      ...
      { question: "Simon lives on a farm ____ he is a farmer.", answers: ["but", "because", "also"], correctAnswerIndex: 1 },
  ...
  },
  {
    ...
    questions: [
      ...
      { question: "Jack doens't ____ the sea.", answers: ["love", "loves"], correctAnswerIndex: 0 },
      ...
      { question: "", answers: ["whisper", "talk", "speak", "shout"], correctAnswerIndex: 0, image: "img/quizImg/whisper.jpg" },
          ...
          { question: "", answers: ["remember", "understand", "act", "carry"], correctAnswerIndex: 3, image: "img/quizImg/carry.jpg" },
      ...
      { question: "Can we climb that mountain?", answers: ["Yes, we can.", "No, we can."], correctAnswerIndex: 0 },
      { question: "Paul and Jerry don't like the ocean because they ____ swim.", answers: ["can", "can't"], correctAnswerIndex: 1 },
      { question: "My mother ____ lisf that bag because it's too heavy.", answers: ["can", "can't"], correctAnswerIndex: 1 },
      ...
      { question: "Ben always listens ____ .", answers: ["careful", "carefully"], correctAnswerIndex: 1 },
      ...
      { question: "Sam ____ to have a pizza.", answers: ["want", "wants"], correctAnswerIndex: 1 },
      { question: "Sam ____ like to eat mushrooms.", answers: ["don't", "doesn't"], correctAnswerIndex: 1 },
  ...
  },
  {
    group: "4.1",
    questions: [
      { question: "I ____ Australian.", answers: ["am", "are", "is"], correctAnswerIndex: 0 },
      { question: "You ____ Australian.", answers: ["am", "are", "is"], correctAnswerIndex: 1 },
      { question: "He ____ is German.", answers: ["am", "are", "is"], correctAnswerIndex: 2 },
      { question: "She ____ French.", answers: ["am", "are", "is"], correctAnswerIndex: 2 },
      { question: "We ____ American.", answers: ["am", "are", "is",], correctAnswerIndex: 0 },
      { question: "You ____ 40 years old.", answers: ["are", "is"], correctAnswerIndex: 0 },
